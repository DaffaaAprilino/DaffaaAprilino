...
[![Skill Icons](https://skillicons.dev/icons?i=js,ts,php,java,kotlin,cs,html,css,react,nextjs,tailwind,bootstrap,laravel,nodejs,mysql,postgres,unity,androidstudio,figma,canva&perline=10)](https://skillicons.dev)
